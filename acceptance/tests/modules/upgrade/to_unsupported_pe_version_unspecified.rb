test_name "puppet module upgrade (where newer version does not support pe version on SUT and version is unspecified)"
...
step "upgrade module" do
  on(master, puppet("module upgrade #{module_author}-#{module_name}"))
